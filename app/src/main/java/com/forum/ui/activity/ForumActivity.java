...
import com.forum.ui.holder.LoadMoreFooter;
...
import com.forum.ui.listener.NavigationOpenClickListener;
...
import com.forum.ui.view.IMainView;
import com.forum.ui.widget.NavigationItem;
...
public class ForumActivity extends FullLayoutActivity implements IMainView, IBackToContentTopView, SwipeRefreshLayout.OnRefreshListener, LoadMoreFooter.OnLoadMoreListener {
    ...
    private class OtherNavigationItemAction implements Runnable {
        ...
        public void run() {
            if (gotoClz == NotificationActivity.class) {
                Navigator.NotificationWithAutoCompat.start(ForumActivity.this);
            } else {
                startActivity(new Intent(ForumActivity.this, gotoClz));
            }
        }
        ...
        AlertDialogUtils.createBuilderWithAutoTheme(this)
                ...
                .setPositiveButton(R.string.logout, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        LoginShared.logout(ForumActivity.this);
