...
public final class ApiDefine {
    ...
    public static final String HOST_BASE_URL = "http://ethantse.top:33";
    ...
    public static final String USER_AGENT = "CAR/" + BuildConfig.VERSION_NAME + " (Android " + Build.VERSION.RELEASE + "; " + Build.MODEL + "; " + Build.MANUFACTURER + ")";
